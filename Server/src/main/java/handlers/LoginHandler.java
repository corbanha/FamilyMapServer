...
public class LoginHandler implements HttpHandler {
    ...
    /**
     * Handles the given httpExchange when the client sends a /login request
     * @param httpExchange
     * @throws IOException
     */
    @Override
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        try{
            if(requestMethod.equals("POST")){
                LoginRequest loginRequest = new Gson().fromJson(new InputStreamReader(httpExchange.getRequestBody()), LoginRequest.class);

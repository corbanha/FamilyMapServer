...
public class Event {
     ...
     * @param year
     */
    public Event(String eventID, String personID, String latitude, String longitude,
    ...
    public String toString() {
        return eventID + " " + personID + " " + latitude + " " + longitude + " " +
                country + " " + city + " " + eventType + " " + year;
    }

    public String searchString(){
        return country + " " + city + " " + eventType + " " + year;
    }
